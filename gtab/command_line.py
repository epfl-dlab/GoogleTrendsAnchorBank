...
def _load_dir_cl():
    ...
    # with open(os.path.join(dir_cl, "config", "config_cl.json"), 'r') as fp:
    #     config = json.load(fp)
...
def set_options():
    ...
    parser.add_argument("--thresh_offline", type = int, dest  = 'gtab.thresh_offline', action = GroupedAction, default = argparse.SUPPRESS)

    parser.add_argument("--backoff_factor", type = float, dest  = 'conn.backoff_factor', action = GroupedAction, default = argparse.SUPPRESS)
    parser.add_argument("--proxies", type = str, dest  = 'conn.proxies', action = GroupedAction, default = argparse.SUPPRESS, nargs = "+")
    parser.add_argument("--retries", type = int, dest  = 'conn.retries', action = GroupedAction, default = argparse.SUPPRESS)
    parser.add_argument("--timeout", type = int, dest  = 'conn.timeout', action = GroupedAction, default = argparse.SUPPRESS, nargs = 2)
