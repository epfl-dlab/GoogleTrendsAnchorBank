...
matplot(ts_repr[,ncol(ts_repr):1], type='l', lty=1, log='y', col=1:6)
legend('topright', rev(mid2name(names(calibration))), lty=1, col=1:6, bty='n')

plot(calibration, log='y')

# Test binary search.
# Jever
binsearch('/m/0fxy5k', calibration, plot=TRUE)
# Audi
binsearch('/m/0h5z20c', calibration, plot=TRUE)
# Stanford University
binsearch('/m/06pwq', calibration, plot=TRUE)
# EPFL
binsearch('/m/0jg7r', calibration, plot=TRUE)
# Donald Trump
binsearch('/m/0cqt90', calibration, plot=TRUE)
